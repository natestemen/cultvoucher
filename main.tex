...
\begin{entry}{Member of Technical Staff}{Unitary Fund}{2022--}
	\item Maintain python package \texttt{mitiq} (>70,000 downloads) used for improving the results of quantum algorithms via quantum error mitigation.
	\item Implemented calibration module to detect optimal error mitigation strategy for particular hardware.
	\item Organizer for UnitaryHACK 2023.
\end{entry}
