...
\begin{entry}{Content Development Specialist}{Overleaf (\emph{part time})}{Oct 2021--now}
	\item Write and improve technical content on using \LaTeX{} and Overleaf with a focus on student oriented content.
\end{entry}
...
\secitem{Strategic Plan Implementation Working Group}{University of Waterloo}{Jan--Sep 2021}
\begin{itemize}
