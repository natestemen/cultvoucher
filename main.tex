...
\begin{entry}{Member of Technical Staff}{Unitary Fund}{2022--}
	\item Core maintainer of python package \texttt{mitiq} (>70,000 downloads) used for improving the results of quantum algorithms via quantum error mitigation.
	\item Implemented calibration module to detect optimal error mitigation strategy on user backend.
	\item UnitaryHACK 2023 Director.
\end{entry}
