...
\begin{entry}{Member of Technical Staff}{Unitary Fund}{Mar 2022--}
	\item Lead developer for the open-source \keyword{Python} package \texttt{mitiq} (240,000+ downloads, 110+ citations).
	...
	\item Implemented a calibration module for \texttt{mitiq} that enables users to calibrate error mitigation techniques to their quantum hardware.
		% Developed a novel calibration technique that improves the performance of error mitigation techniques by up to 50\% on noisy quantum devices.
...
% \secitem{Software}{}{}
% \begin{itemize}
% 	\item git/GitHub, docker, Linux, MacOS
% \end{itemize}
